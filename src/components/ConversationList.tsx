...
export function ConversationItem({
  ...
  return (
    <div
      ...
      className={`
        group relative mx-2 mb-0.5 px-3 py-2.5 rounded-xl cursor-pointer
    ...
    >
      ...
      <div className={`
        ...
        ${isActive
          ? `h-7 ${isDark ? 'bg-blue-400' : 'bg-blue-500'}`
          : 'h-0 bg-transparent'
        }
      `} />
        ...
        <div className="flex items-center justify-between gap-2">
          ...
          <div className="flex gap-1">
            <button
              ...
              className="px-2 py-1 text-xs text-red-400 hover:text-red-300 hover:bg-red-500/20 rounded-lg transition-colors"
            >
              Ja
            </button>
            <button
          ...
          <div className="pr-7">
            <p className={`
              ...
              ${isActive
                ...
                : isDark ? 'text-gray-300 group-hover:text-gray-200' : 'text-gray-700 group-hover:text-gray-900'
              }
            `}>
              {conversation.title}
            </p>
            <p className={`
              ...
              ${isActive
                ...
                : isDark ? 'text-gray-600 group-hover:text-gray-500' : 'text-gray-400'
              }
            `}>
              {conversation.messages.length} Nachrichten · {formatDate(conversation.updatedAt)}
            </p>
          </div>
